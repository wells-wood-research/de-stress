				...
				A2(
					...
					_List_fromArray(
						[
							...
							currentRoute,
							_Utils_Tuple2('Designs', $author$project$Generated$Routes$routes.notFound)),
							A2(
							$author$project$Layout$viewLink,
							currentRoute,
							_Utils_Tuple2('Reference Sets', $author$project$Generated$Routes$routes.notFound)),
							A2(
							$author$project$Layout$viewLink,
							currentRoute,
							...
							$author$project$Layout$viewLink,
							currentRoute,
							_Utils_Tuple2('Settings', $author$project$Generated$Routes$routes.notFound))
						])))
			]));
};
